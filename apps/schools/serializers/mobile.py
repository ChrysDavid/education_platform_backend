...
class SchoolTypeSerializer(SchoolTypeBaseSerializer):
    """
    Sérialiseur pour l'API mobile des types d'établissements.
    """
...
class CitySerializer(CityBaseSerializer):
    """
    Sérialiseur pour l'API mobile des villes.
    """
    school_count = serializers.SerializerMethodField()
...
class SchoolContactSerializer(SchoolContactBaseSerializer):
    """
    Sérialiseur pour l'API mobile des contacts des établissements.
    """
...
class FacilitySerializer(FacilityBaseSerializer):
    """
    Sérialiseur pour l'API mobile des équipements des établissements.
    """
...
class DepartmentSerializer(DepartmentBaseSerializer):
    """
    Sérialiseur pour l'API mobile des départements des établissements.
    """
...
class ProgramSerializer(ProgramBaseSerializer):
    """
    Sérialiseur pour l'API mobile des programmes académiques.
    """
...
class SchoolReviewSerializer(SchoolReviewBaseSerializer):
    """
    Sérialiseur pour l'API mobile des évaluations des établissements.
    """
...
class SchoolMediaSerializer(SchoolMediaBaseSerializer):
    """
    Sérialiseur pour l'API mobile des médias des établissements.
    """
...
class SchoolEventSerializer(SchoolEventBaseSerializer):
    """
    Sérialiseur pour l'API mobile des événements des établissements.
    """
...
class SchoolListSerializer(SchoolBaseSerializer):
    """
    Sérialiseur pour l'API mobile de la liste des établissements (version légère).
    """
...
class SchoolDetailSerializer(serializers.ModelSerializer):
    """
    Sérialiseur détaillé pour l'API mobile des établissements.
    """
    ...
    media = SchoolMediaSerializer(many=True, read_only=True)
    ...
    def get_reviews(self, obj):
        ...
        reviews = obj.reviews.filter(is_public=True)
        return SchoolReviewSerializer(reviews, many=True).data
...
class SchoolCreateUpdateSerializer(serializers.ModelSerializer):
    """
    Sérialiseur pour l'API mobile de création et de mise à jour des établissements.
    """
    class Meta:
        model = School
